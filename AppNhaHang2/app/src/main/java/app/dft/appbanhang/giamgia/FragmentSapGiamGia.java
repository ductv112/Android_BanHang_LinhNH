...
public class FragmentSapGiamGia extends Fragment {
    ...
    public FragmentSapGiamGia() {
        // Required empty public constructor
    }


    public FragmentSapGiamGia(String productTypeId, String trademarkId) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_sap_giam_gia, container, false);
    ...
    public static void GetData() {
        ...
        String url = StaticVariable.apiSapGiamGia + "&page=" + page + "&limit=" + limit;
